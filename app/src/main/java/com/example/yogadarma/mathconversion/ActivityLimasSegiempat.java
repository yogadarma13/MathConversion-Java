...
public class ActivityLimasSegiempat extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_limas_segiempat);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(sisi.getText().toString().trim().length() > 0 && tinggi.getText().toString().trim().length() > 0) {
                    ...
                    double volumeLimas = 1.0 / 3.0 * (sisiAlas * sisiAlas) * tinggiLimas;

                    volume.setText(String.valueOf(String.format("%.2f", volumeLimas)));
                }else {
                    Toast.makeText(ActivityLimasSegiempat.this, "Kolom tidak boleh kosong", Toast.LENGTH_SHORT).show();
                    volume.setText("0");
                }
            }
        });
