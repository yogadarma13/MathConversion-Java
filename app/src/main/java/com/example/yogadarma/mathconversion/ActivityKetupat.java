...
public class ActivityKetupat extends AppCompatActivity {
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(diagonal1.getText().toString().trim().length() > 0 && diagonal2.getText().toString().trim().length() > 0) {
                    ...
                    double luasKetupat = 0.5 * diagonalKetupat1 * diagonalKetupat2;

                    luas.setText(String.valueOf(String.format("%.2f", luasKetupat)));
                } else {
                    Toast.makeText(ActivityKetupat.this, "Kolom tidak boleh kosong", Toast.LENGTH_SHORT).show();
                    luas.setText("0");
                }
            }
        });
